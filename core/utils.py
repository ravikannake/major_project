...
def recognize_plate(img, coords):
    ...
    # Apply median blur
    carplate_extract_img_gray_blur = cv2.medianBlur(gray,3) # kernel size 3

    # Testing all PSM values
    for i in range(3,14):
      print(f'PSM: {i}')
      print(pytesseract.image_to_string(carplate_extract_img_gray_blur,
            config = f'--psm {i} --oem 1 -c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))
...
def format_boxes(bboxes, image_height, image_width):
    for box in bboxes:
        ...
        #print('({},{}),({},{}),({},{}),({},{})'.format(xmin,ymax,xmax,ymax,xmax,ymin,xmin,ymin))
